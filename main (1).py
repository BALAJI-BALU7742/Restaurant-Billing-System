...
def send_email():
    def send_gmail():
        try:
            ...
            sender_email = "balubheemireddi5286@gmail.com"
            password = "Balu@7742"
...
headingLabel=Label(root,text="Welcome to MyWorld Billing System",font=("times new roman",30,"bold"),bg="gray20",fg="gold",bd=14,relief=GROOVE)# can be editable after also will ask from all 
